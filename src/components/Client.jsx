...
const Client = () => {
  return (
    <div className="grid xl:grid-cols-4 gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 mt-10 h-full font-montserrat">
      <div className="relative group">
        ...
        <div className="rounded-lg bg-[#01031f] shadow-sm relative h-full">
          <div className="flex flex-col items-center p-3">
            ...
            <div className="text-white mt-4 opacity-80 px-3 py-2 italic">
          ...
          <div className="flex flex-col items-center p-3">
            <div className="flex flex-row items-center justify-start w-full">
              ...
              <div className="flex flex-col text-white ml-3">
                ...
                <p className="opacity-60 text-sm">Somya Khedia</p>
              </div>
            </div>
            <div className="text-white mt-4 opacity-80 px-3 py-2 italic">
              <span className="text-2xl leading-none">&quot;</span>
              Developing our website allowed us to sell our clothing online, and
              the ongoing partnership has been key to our online success.
              <span className="text-2xl leading-none">&quot;</span>
            </div>
          </div>
        </div>
      ...
      <div className="relative group">
        ...
        <div className="rounded-lg bg-[#01031f] shadow-sm relative">
          <div className="flex flex-col items-center p-3">
            ...
            <div className="text-white mt-4 opacity-80 px-3 py-2 italic ">
              <span className="text-2xl leading-none">&quot;</span>His
              communication throughout the development process was easy and
              open, making it a smooth and successful collaboration
              <span className="text-2xl leading-none">&quot;</span>
            </div>
          </div>
        </div>
      ...
      <div className="relative group ">
        ...
        <div className="rounded-lg bg-[#01031f] shadow-sm relative h-full">
          <div className="flex flex-col items-center p-3">
            ...
            <div className="text-white mt-4 opacity-80 px-3 py-2 italic">
              <span className="text-2xl leading-none">&quot;</span>A smooth
              process
              <span className="text-2xl leading-none">&quot;</span>
            </div>
          </div>
